...
enum doca_action_type {
	...
	DOCA_ACTION_DEVEMU_PCI_FIRST = 3 << DOCA_ACTION_SDK_RANGE,
	DOCA_ACTION_VIRTIO_FS_FIRST = 4 << DOCA_ACTION_SDK_RANGE,
	...
	DOCA_ACTION_RDMA_FIRST = 13 << DOCA_ACTION_SDK_RANGE,
	DOCA_ACTION_GRAPH_FIRST = 14 << DOCA_ACTION_SDK_RANGE,
	DOCA_ACTION_SYNC_EVENT_FIRST = 15 << DOCA_ACTION_SDK_RANGE,
	DOCA_ACTION_DPI_FIRST = 16 << DOCA_ACTION_SDK_RANGE,
	DOCA_ACTION_EC_FIRST = 17 << DOCA_ACTION_SDK_RANGE,
	DOCA_ACTION_NVRD_TRANSPORT_FIRST = 18 << DOCA_ACTION_SDK_RANGE,
};
 ...
 * @note job->ctx must not be NULL, must be started and associated with the workq. Otherwise undefined behaviour.
 */
__DOCA_EXPERIMENTAL
 ...
 * @note event driven mode must be active by using doca_workq_set_event_driven_enable(). Otherwise undefined behaviour.
 */
__DOCA_EXPERIMENTAL
 ...
 */
__DOCA_EXPERIMENTAL
doca_error_t doca_workq_set_event_handle(struct doca_workq *workq, doca_event_handle_t event_handle,
 ...
 *				I.e., the device is not useful for any job, missing the capabilities,
 *				or was opened using doca_dev_open_from_pd().
