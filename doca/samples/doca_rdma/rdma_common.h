...
#define DEFAULT_LOCAL_CONNECTION_DESC_PATH	"/home/annali/doca/samples/doca_rdma/rdma_receive/build/lcdpath.txt"	/* Default path to save the local connection information */
#define DEFAULT_REMOTE_CONNECTION_DESC_PATH	"/home/annali/doca/samples/doca_rdma/rdma_send/build/rcdpath.txt"	/* Default path to save the remote connection information */
#define DEFAULT_MMAP_CONNECTION_DESC_PATH	"/home/annali/doca/samples/doca_rdma/rdma_receive/build/mcdpath.txt"	/* Default path to read/save the remote mmap connection information */
