...
NAME_TO_PORT = 	{
			# Applications
			'doca_url_filter':		gen_common.eNetworkPort.k_UrlFilter,
			'doca_dns_filter':		gen_common.eNetworkPort.k_DnsFilter,
			'doca_application_recognition':	gen_common.eNetworkPort.k_ApplicationRecognition,
			'doca_ips':			gen_common.eNetworkPort.k_Ips,
			# Infrastructure
